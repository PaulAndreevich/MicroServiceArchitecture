...
public class ReservationController {
    ...
    @PutMapping(path = "reservations/{id}/seat/{seatid}")
    public void addSeatToReservation(@PathVariable Long id, @PathVariable Long seatid){
        System.out.println("ADDED" + seatid + " TO " + id + "RESERVATION" );
        logic.addSeatToReservation(id,seatid);
    }
